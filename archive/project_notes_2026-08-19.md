# project_notes 아카이브 — 2026-08-19

> `project_notes.md`에서 원문 그대로 이관 (2026-08-21, AGENTS.md ④-1 회전).
> 이관 사유: live 파일 148KB로 150KB 한도에 근접 — 다음 추가분에서 즉시 초과. **2026-08-19 엔트리 42건.**
> 블록 무손실 대조 완료. 원문 그대로이며 편집하지 않는다.
> 인용은 행 번호가 아니라 **날짜+엔트리 제목**으로 한다.
> 2026-08-20 이후 기록은 [`../project_notes.md`](../project_notes.md)에 있다.
