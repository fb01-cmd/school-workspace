# project_notes 아카이브 — 2026년 7월 핸드오버 일지

> `project_notes.md`의 핸드오버 기록 중 2026-07-22 ~ 2026-07-31 엔트리 156건을 2026-08-05 아카이브 회전으로 **원문 그대로** 이관했다 (회전 규칙: AGENTS.md). 인용은 행 번호가 아닌 날짜+제목으로 할 것.
