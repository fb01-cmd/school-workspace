# Project Notes — 2026-08-20 (아카이브)

> `project_notes.md`가 150KB 한도를 넘어 2026-08-21에 회전했다 (AGENTS.md ④-1).
> **원문 그대로 옮겼고 한 줄도 고치지 않았다.** 최근 엔트리는 [`../project_notes.md`](../project_notes.md)에 있다.
