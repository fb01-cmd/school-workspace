      ...
      <div className="max-w-4xl mx-auto space-y-6">
            ...
            <table className="w-full text-left text-xs sm:text-sm">
              ...
              <tbody className="divide-y divide-slate-100 text-slate-600">
                ...
                <tr>
                  ...
                  <td className={tdClass}>보낸 달로부터 12개월이 지난 달 1일에 파기(실제 보존 약 11~12개월). 쪽지함에서 삭제하면 본인 화면에서만 지워지고, 원본은 보존 기간까지 남습니다</td>
                </tr>
                <tr>
        ...
        <div className={sectionClass}>
          ...
          <ul className={`list-disc list-inside ${bodyTextClass} space-y-1.5`}>
            ...
            {/* CSP는 아직 관찰 모드라 적지 않는다 — 시행 전환 시 이 줄을 갱신 (미확인·미시행은 기재하지 않는 원칙) */}
            <li>브라우저 보안 장치를 적용합니다 — 다른 사이트가 이 화면을 몰래 끼워 넣는 것(클릭 유도 위장)과 파일을 실행 코드로 위장하는 것을 차단하고, 외부 사이트로 이동할 때 주소의 세부 정보를 보내지 않습니다.</li>
