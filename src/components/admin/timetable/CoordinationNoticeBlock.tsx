      ...
      {isSimul && coordination.simul && (
        <div className="space-y-1.5 pt-0.5">
            ...
            <div className="grid grid-cols-1 gap-1">
              {coordination.simul.steps.map((step, idx) => (
                <div
                  ...
                  className="text-[10px] leading-tight text-gray-900 bg-gray-50 rounded p-1.5 border border-gray-200 flex items-center justify-between"
                >
                  <span>
          ...
          {coordination.simul.warnings && coordination.simul.warnings.length > 0 && (
            <div className="text-[10px] text-amber-900 bg-amber-50 rounded p-1.5 border border-amber-200 font-semibold">
